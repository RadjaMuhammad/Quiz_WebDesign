                    ...
                    <div class="card-body">
                        <form action="proses_edit.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="<?=$data['nohp']?>" name="nohp" type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="rumpun" id="">
                                    ...
                                    <option <?php echo $data['rumpun']=='Sastra Inggris' ? 'selected' : '' ?> value="Sastra Inggris">Sastra Inggris</option>
